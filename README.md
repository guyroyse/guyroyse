...
I'm a hard-boiled geek interested in more things than I have time for, a husband and father of three, and a Developer Advocate at [Redis](https://redis.io). I live in Ohio and spend my days helping developers build amazing things.
...
Check out my full speaking portfolio on [Sessionize](https://sessionize.com/guyroyse).
...
- [agents-n-arbiters](https://github.com/guyroyse/agents-n-arbiters) — Multi-agent collaboration with LangGraph.js
- [finding-bigfoot-with-semantic-search](https://github.com/guyroyse/finding-bigfoot-with-semantic-search) — Semantic search with Redis and JavaScript
- [modern-problems-require-modern-solutions](https://github.com/guyroyse/modern-problems-require-modern-solutions) — Finding your meme twin with vector search
- [podbot-azure](https://github.com/guyroyse/podbot-azure) — Chat API with Redis Agent Memory Server
- [understanding-probabilistic-data-structures](https://github.com/guyroyse/understanding-probabilistic-data-structures) — Bloom filters, MinHash, and Top-K with UFO sightings

### Radio, Reticulum, and Decentralized Networks

- [mesh-browser](https://github.com/guyroyse/mesh-browser) — Browse websites over Reticulum
- [plucking-data-from-thin-air](https://github.com/guyroyse/plucking-data-from-thin-air) — Software-defined radio workshop
- [rserver](https://github.com/guyroyse/rserver) — A basic HTTP server for the Reticulum Network
- [tracking-aircraft](https://github.com/guyroyse/tracking-aircraft) — Real-time ADS-B flight tracking with Redis Streams

### Code Katas

- [evercraft-kata](https://github.com/guyroyse/evercraft-kata) — Code D&D for fun and profit
- [gilded-rose-javascript](https://github.com/guyroyse/gilded-rose-javascript) — The Gilded Rose refactoring kata
- [vending-machine-kata](https://github.com/guyroyse/vending-machine-kata) — Classic TDD kata


## Let's Connect

- [guy.dev](https://guy.dev)
- [Bluesky](https://bsky.app/profile/guy.dev)
- [Medium](https://medium.com/@guyroyse)
- [X](https://twitter.com/guyroyse)
- [YouTube](https://www.youtube.com/@guyroyse)
